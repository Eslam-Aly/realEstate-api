...
import { verifyEnTemplate } from "../templates/verifyEnTemplate.js";
import { verifyArTemplate } from "../templates/verifyArTemplate.js";
import { resetPassEnTemplate } from "../templates/resetPassEnTemplate.js";
import { resetPassArTemplate } from "../templates/resetPassArTemplate.js";
dotenv.config();
...
export const sendEmailVerification = async (req, res, next) => {
  try {
    ...
    const html =
      lang === "ar" ? verifyArTemplate(link) : verifyEnTemplate(link);
...
export const requestPasswordReset = async (req, res, next) => {
  try {
    ...
    if (user) {
      ...
      const html =
        lang === "ar" ? resetPassArTemplate(link) : resetPassEnTemplate(link);
